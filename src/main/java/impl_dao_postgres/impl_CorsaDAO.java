...
public class impl_CorsaDAO implements CorsaDAO {
    ...
    public void login_passeggero(ArrayList<Integer> id_passeggero,ArrayList<String> nome,ArrayList<String> login,ArrayList<String> password,ArrayList<Integer> eta,String login_in,String password_in){
        try {
            connection.setAutoCommit(false);
            String query = "{ ? = call login_passeggero(?,?) }";
            CallableStatement p_s = connection.prepareCall(query);
    ...
    public void login_compagnia(ArrayList<Integer> id_compagnia,ArrayList<String> nome,ArrayList<String> login,ArrayList<String> password,ArrayList<String> telefono,ArrayList<String> mail,ArrayList<String> sito_web,String login_in,String password_in){
        try {
            connection.setAutoCommit(false);
            String query = "{ ? = call login_compagnia(?,?) }";
            CallableStatement p_s = connection.prepareCall(query);
            p_s.setString(2, login_in);
            p_s.setString(3, password_in);
    ...
    public void retrieve_biglietti_ridotti(Integer id_passeggero,ArrayList<Float> importo_totale,ArrayList<Float> Sovrapprezzo_tot,ArrayList<Integer> n_bagagli,ArrayList<String> veicolo,ArrayList<Timestamp> prenotazione,ArrayList<Integer> corsa,ArrayList<Integer> accompagnatore){
        try{
            connection.setAutoCommit(false);
    ...
    public void retrieve_corse_compagnia(Integer id_compagnia,ArrayList<Integer> id_corsa,
        ...
        try {
            ...
            while(rs.next()) {
                ...
                nome_natante.add(rs.getString("Nome"));
                trasporta.add(rs.getString("Trasporta"));
                tipo_natante.add(rs.getString("Tipo"));
    ...
    public void change_password(String login,String new_password,String old_password){
        try{
            ...
            System.out.println("error in impl_corsa_dao change_password");
            throw new RuntimeException(e);
        }
    }
    ...
    public void change_login(String old_login,String new_login,String password){
        try{
            ...
            System.out.println("error in impl_corsa_dao change_login");
            throw new RuntimeException(e);
        }
    }
