...
public interface CorsaDAO {
    ...
    void retrieve_biglietti_ridotti(Integer id_passeggero,ArrayList<Float> importo_totale,ArrayList<Float> Sovrapprezzo_tot,ArrayList<Integer> n_bagagli,ArrayList<String> veicolo,ArrayList<Timestamp> prenotazione,ArrayList<Integer> corsa,ArrayList<Integer> accompagnatore);
    ...
    void change_password(String login,String new_password,String old_password);
    void change_login(String old_login,String new_login,String password);
