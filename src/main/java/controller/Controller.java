...
public class Controller {
    ...
    public ArrayList<Corsa> filtra_corse(Integer id_corsa,String portoPartenza,String portoArrivo ,Date dataPartenza,Time orarioPartenza,Float prezzo ,String tipo_natante){
    ...
    public Passeggero retrieve_passeggero(Integer id_passeggero){
        ArrayList<String> nome=new ArrayList<>();
        ArrayList<String> login=new ArrayList<>();
        ArrayList<String> password=new ArrayList<>();
        ArrayList<Integer> eta=new ArrayList<>();
    ...
    public ArrayList<Biglietto_Intero> retrieve_biglietti_interi(Integer id_passeggero){
    ...
    public ArrayList<Biglietto_Ridotto> retrieve_biglietti_ridotti(Integer id_passeggero){
        ArrayList<Float> importo_totale=new ArrayList<>();
        ArrayList<Float> Sovrapprezzo_tot=new ArrayList<>();
        ArrayList<Integer> n_bagagli=new ArrayList<>();
        ArrayList<String> veicolo=new ArrayList<>();
        ...
        CorsaDao.retrieve_biglietti_ridotti(id_passeggero,importo_totale,Sovrapprezzo_tot,n_bagagli,veicolo,prenotazione,corsa,accompagnatore);
    ...
    public ArrayList<Corsa> retrieve_corse_compagnia(Compagnia compagnia){
    ...
    public ArrayList<Passeggero> retrieve_accompagnatori(){
        ArrayList<Integer> id_passeggero=new ArrayList<>();
        ArrayList<String> nome=new ArrayList<>();
        ArrayList<String> login=new ArrayList<>();
        ArrayList<String> password=new ArrayList<>();
    ...
    public ArrayList<Porto> retrieve_porti(){
    ...
    public ArrayList<Natante> retrieve_natanti(){
    ...
    public void change_password(String login,String new_password,String old_password){
        CorsaDao.change_password(login, new_password, old_password);
    }
    public void change_login(String old_login,String new_login,String password){
        CorsaDao.change_login(old_login, new_login, password);
    }

    public ArrayList<Social> retrieve_social(int id_compagnia){
